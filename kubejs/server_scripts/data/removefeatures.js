ServerEvents.highPriorityData(e => {
    ...
    "forestry:ore_tin",
    "nuclearcraft:boron",
    "nuclearcraft:boron_wasteland",
    "nuclearcraft:cobalt",
    "nuclearcraft:cobalt_wasteland",
    "nuclearcraft:lead",
    "nuclearcraft:lead_wasteland",
    "nuclearcraft:lithium",
    "nuclearcraft:lithium_wasteland",
    "nuclearcraft:magnesium",
    "nuclearcraft:magnesium_wasteland",
    "nuclearcraft:platinum",
    "nuclearcraft:platinum_wasteland",
     "nuclearcraft:silver",
     "nuclearcraft:silver_wasteland",
     "nuclearcraft:thorium_additional_wasteland",
     "nuclearcraft:thorium",
     "nuclearcraft:thorium_wasteland",
     "nuclearcraft:tin",
     "nuclearcraft:tin_wasteland",
     "nuclearcraft:uranium_additional_wasteland",
     "nuclearcraft:uranium",
     "nuclearcraft:uranium_wasteland",
     "nuclearcraft:zinc_wasteland",
      "nuclearcraft:zinc",
     "powah:uraninite_ore",
