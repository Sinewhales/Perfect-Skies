...
.requireItemTag('#integrateddynamics:menril_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItem('solarcraft:runic_log', "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItem('solarcraft:radiant_log', "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#aether:crafts_skyroot_planks', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#undergarden:smogstem_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#undergarden:wigglewood_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#undergarden:grongle_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#forge:rubberwood_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#botania:livingwood_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#botania:dreamwood_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#quark:ancient_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#quark:azalea_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#quark:blossom_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#architects_palette:twisted_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#twilightforest:twilight_oak_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#twilightforest:canopy_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#twilightforest:mangrove_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#twilightforest:darkwood_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#twilightforest:timewood_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#twilightforest:transwood_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#twilightforest:mining_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#twilightforest:sortwood_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#palegardenbackport:pale_oak_log_blocks', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#traverse:fir_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#netherexp:claret_stems', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItem('tropicraft:mahogany_log', "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItem('tropicraft:palm_log', "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#tropicraft:mangrove_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#terrestria:cypress_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#terrestria:hemlock_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#terrestria:japanese_maple_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#terrestria:rainbow_eucalyptus_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#terrestria:redwood_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#terrestria:rubber_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#terrestria:sakura_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#terrestria:willow_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#terrestria:yucca_palm_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#hexerei:mahogany_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#hexerei:willow_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#hexerei:witch_hazel_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#tconstruct:greenheart_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#tconstruct:skyroot_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#tconstruct:bloodshroom_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#tconstruct:enderbark_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#forge:logs/archwood', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#forbidden_arcanus:fungyss_stems', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#forbidden_arcanus:mysterywood_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#forbidden_arcanus:edelwood_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#malum:soulwood_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#malum:runewood_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#environmental:willow_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#environmental:pine_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#environmental:plum_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#environmental:wisteria_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
...
.requireItemTag('#phantasm:pream_logs', 1, "input5").damageItemTag('#cb_microblock:tools/saw', 1, "tool")
})
