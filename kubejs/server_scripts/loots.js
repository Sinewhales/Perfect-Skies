...
ServerEvents.chestLootTables(event => {
	...
	event.addChest('kubejs:t1_lootbags', t => {
		t.addPool(p => {
			p.rolls = 1
			p.addItem('64x minecraft:oak_log', 1).weight(3)
			p.addItem('9x terrestria:redwood_sapling', 1).weight(3)
			p.addItem('minecraft:bucket', 1).weight(3)
			p.addItem('6x minecraft:paper', 1).weight(3)
			p.addItem('4x minecraft:sugar_cane', 1).weight(3)
			p.addItem('3x minecraft:cactus', 1).weight(3)
			p.addItem('2x minecraft:black_dye', 1).weight(3)
			p.addItem('2x minecraft:book', 1).weight(3)
			p.addItem(Item.of('fluidtank:tank_stone', '{BlockEntityTag:{ForgeCaps:{},tank:{amount_generic:[B;19B,-58B,-128B],content:{amount_generic:[B;19B,-58B,-128B],content:"minecraft:water"},type:"Tank"},tier:"STONE"}}'), 1).weight(2)
			p.addItem('3x rusticdelight:cotton_seeds', 1).weight(2)
			p.addItem('3x tconstruct:pattern', 1).weight(2)
			p.addItem('6x oreberriesreplanted:essence_berry_bush', 1).weight(2)
			p.addItem('2x oreberriesreplanted:iron_oreberry_bush', 1).weight(2)
			p.addItem('2x oreberriesreplanted:gold_oreberry_bush', 1).weight(2)
			p.addItem('2x oreberriesreplanted:copper_oreberry_bush', 1).weight(2)
			p.addItem('2x oreberriesreplanted:tin_oreberry_bush', 1).weight(2)
			p.addItem('2x oreberriesreplanted:aluminum_oreberry_bush', 1).weight(2)
			p.addItem('2x oreberriesreplanted:nickel_oreberry_bush', 1).weight(2)
			p.addItem('2x oreberriesreplanted:silver_oreberry_bush', 1).weight(2)
			p.addItem(Item.of('sophisticatedstorage:iron_chest', '{woodType:"oak"}'), 1).weight(2)
			p.addItem(Item.of('sophisticatedstorage:iron_barrel', '{woodType:"oak"}'), 1).weight(2)
			p.addItem(Item.of('cb_microblock:diamond_saw', '{Damage:0,Unbreakable:1}'), 1).weight(1)
			p.addItem(Item.of('kubejs:plate_hammer', '{Damage:0,Unbreakable:1}'), 1).weight(1)
			p.addItem(Item.of('tconstruct:pick_head', '{Material:"tconstruct:bronze"}'), 1).weight(1)
			p.addItem(Item.of('sophisticatedstorage:diamond_chest', '{woodType:"oak"}'), 1).weight(1)
			p.addItem('minecraft:anvil', 1).weight(1)
